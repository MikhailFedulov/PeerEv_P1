...
class CreateCourse extends Component {
        ...
        handleAddCourse = async event =>  {
            ...
            this.setState({ courseTitle: "", courseBody: "", numberofstudents: ""})
        }
     ...
     render() {
             return (
                 ...
                 <input style={{ font: '19px'}} type="text" placeholder="Title" name="courseTitle" required value={this.state.courseTitle} onChange={this.handleChangeCourse}/>

                  <input style={{ font: '19px'}} type="text" placeholder="Course Describtion" name="courseBody" required value={this.state.courseBody} onChange={this.handleChangeCourse}/>

                 <input style={{ font: '19px'}} type="text" placeholder="Students" name="numberofstudents" required value={this.state.numberofstudents} onChange={this.handleChangeCourse}/>
